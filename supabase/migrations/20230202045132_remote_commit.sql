...
--
-- Name: pricing_plan_interval; Type: TYPE; Schema: public; Owner: supabase_admin
--
...
ALTER TYPE "public"."pricing_plan_interval" OWNER TO "supabase_admin";

--
-- Name: pricing_type; Type: TYPE; Schema: public; Owner: supabase_admin
--
...
ALTER TYPE "public"."pricing_type" OWNER TO "supabase_admin";

--
-- Name: subscription_status; Type: TYPE; Schema: public; Owner: supabase_admin
--
...
ALTER TYPE "public"."subscription_status" OWNER TO "supabase_admin";
...
--
-- Name: prices; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE "public"."prices" OWNER TO "supabase_admin";
...
--
-- Name: prices prices_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: customers customers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: prices prices_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: subscriptions subscriptions_price_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: subscriptions subscriptions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: prices Allow public read-only access.; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: products Allow public read-only access.; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: subscriptions Can only view own subs data.; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: prices; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: TABLE "prices"; Type: ACL; Schema: public; Owner: supabase_admin
--
